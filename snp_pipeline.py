...
def main():
	...
	# Convert files and merge filenames for final output
	os.system("vcf_samplename_editior.py -i "+outdir+"/total_variants.vcf -s "+outdir+"/samplenames.txt")
	os.system("vcf_samplename_editior.py -i "+outdir+"/total_variants.vcf -s "+outdir+"/samplenames.txt")
	os.system("vcf_accessory_genome_filter.py -i + "outdir+"/total_variants_renamed.vcf -r "+args.reference)
	os.system("vcf_to_matrix.py -i + "outdir+"/total_variants_renamed.vcf")
	os.system("vcf_to_matrix.py -i + "outdir+"/total_variants_renamed_no_accessory.vcf")
